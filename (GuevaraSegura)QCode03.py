...
canvas=Canvas(root,width=930,height=500,background='white',curser='hand2')
canvas.place(x=100,y=10)
canvas.bind('<Button-1>',locate_xy)
canvas.bind('<Bl-Motion>',addLine)

current_value=tk.DoubleVar()

def get_current_value():
    return'[:.2f]'.formate(float(current_value.get()))
...
#end of the code for making of a whiteboard
